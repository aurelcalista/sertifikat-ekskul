...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div id="previewCard" class="card card-custom mt-4 p-3 p-md-4 border border-success-subtle shadow-sm d-none" style="position: relative; overflow: hidden;">
                ...
                <div class="text-center mb-4 mt-2">
                    ...
                    <h3 class="fw-bold text-dark mb-1">Pratinjau Sertifikat</h3>
                    <p class="text-muted small mb-0">Silakan periksa detail informasi di bawah ini sebelum mengunduh.</p>
                </div>
                ...
                <div class="preview-certificate-container p-3 p-md-4 mb-3 position-relative overflow-hidden">
                    ...
                    <div class="row align-items-center mb-3 position-relative" style="z-index: 5; text-align: left;">
                        ...
                        <div class="col-md-2 text-center text-md-end d-none d-md-block">
                            <!-- Gold Seal Badge -->
                            <div class="preview-gold-seal-badge" style="width: 50px; height: 50px;">
