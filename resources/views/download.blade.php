                    ...
                    <div class="modal-content border-0 shadow-lg rounded-4">
                        ...
                        <div class="modal-body p-4 bg-light">
                            ...
                            <div class="preview-certificate-container p-3 p-md-4 mb-3 position-relative overflow-hidden" style="aspect-ratio: 297/210; min-height: 380px;">
                                ...
                                <svg viewBox="0 0 400 300" style="position: absolute; top: 0; right: 0; width: 37%; height: auto; z-index: 1; pointer-events: none;">
                                ...
                                <svg viewBox="0 0 400 300" style="position: absolute; bottom: 0; left: 0; width: 37%; height: auto; z-index: 1; pointer-events: none;">
                                ...
                                <!-- Double Gold Borders -->
                                <div style="position: absolute; top: 6px; left: 6px; right: 6px; bottom: 6px; border: 2px solid #C89B3C; z-index: 2; pointer-events: none;"></div>
                                <div style="position: absolute; top: 9px; left: 9px; right: 9px; bottom: 9px; border: 0.75px solid #C89B3C; z-index: 2; pointer-events: none;"></div>

                                <!-- Geometric Corner Patterns -->
                                <div style="position: absolute; top: 9px; left: 9px; z-index: 3; pointer-events: none;">
                                ...
                                <div style="position: absolute; top: 9px; right: 9px; z-index: 3; transform: rotate(90deg); pointer-events: none;">
                                    <svg width="20" height="20" viewBox="0 0 24 24"><path d="M 0,24 L 0,0 L 24,0 M 4,24 L 4,4 L 24,4 M 8,8 L 16,8 L 16,16 L 8,16" fill="none" stroke="#C89B3C" stroke-width="1.5" /></svg>
                                </div>
                                <div style="position: absolute; bottom: 9px; right: 9px; z-index: 3; transform: rotate(180deg); pointer-events: none;">
                                    <svg width="20" height="20" viewBox="0 0 24 24"><path d="M 0,24 L 0,0 L 24,0 M 4,24 L 4,4 L 24,4 M 8,8 L 16,8 L 16,16 L 8,16" fill="none" stroke="#C89B3C" stroke-width="1.5" /></svg>
                                </div>
                                <div style="position: absolute; bottom: 9px; left: 9px; z-index: 3; transform: rotate(270deg); pointer-events: none;">
                                    <svg width="20" height="20" viewBox="0 0 24 24"><path d="M 0,24 L 0,0 L 24,0 M 4,24 L 4,4 L 24,4 M 8,8 L 16,8 L 16,16 L 8,16" fill="none" stroke="#C89B3C" stroke-width="1.5" /></svg>
                                </div>
                                ...
                                <div class="position-relative h-100 d-flex flex-column" style="z-index: 5; gap: 0; text-align: left;">
                                    ...
                                    <div class="text-center w-100" style="margin-bottom: 2px; position: relative;">
                                        ...
                                        <div class="text-center w-100" style="margin-bottom: 1.5px;">
                                        ...
                                        <div style="border-top: 0.75px solid #C89B3C; border-bottom: 0.75px solid #C89B3C; padding: 2px 0; margin: 4px auto; width: 45%; text-align: center;">
                                        ...
                                        <div class="text-center w-100" style="margin-top: 1.5px;">
                                            <svg width="30" height="6" viewBox="0 0 80 8" style="display: inline-block;">
                                                <line x1="0" y1="4" x2="32" y2="4" stroke="#C89B3C" stroke-width="0.5" />
                                                <polygon points="40,2 43,4 40,6 37,4" fill="#C89B3C" />
                                                <line x1="48" y1="4" x2="80" y2="4" stroke="#C89B3C" stroke-width="0.5" />
                                    ...
                                    <div class="text-center w-100" style="position: relative; margin-top: 2px;">
                                        ...
                                        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 140px; height: 90px; z-index: 1; opacity: 0.08; pointer-events: none;">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center" style="margin-top: 4px; position: relative; z-index: 2;">
                                            <svg width="18" height="10" viewBox="0 0 24 12" style="display: inline-block; margin-right: 6px;">
                                            ...
                                            <svg width="18" height="10" viewBox="0 0 24 12" style="display: inline-block; margin-left: 6px; transform: scaleX(-1);">
                                                <path d="M 24,6 Q 12,0 0,6 Q 12,12 24,6 M 18,6 Q 12,3 6,6" fill="none" stroke="#C89B3C" stroke-width="1.2" />
                                            </svg>
                                        </div>
                                    ...
                                    <div class="text-center w-100" style="margin-top: 2px; margin-bottom: 2px;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center w-100" style="padding-top: 4px; margin-top: auto; border-top: 1px solid rgba(232, 213, 163, 0.4);">
                                        ...
                                        <div class="text-center" style="width: 50%;">
                                            <svg width="100" height="20" viewBox="0 0 120 24" style="display: inline-block;">
                                        ...
                                        <div class="text-end" style="font-family:'Poppins',sans-serif; line-height: 1.1; width: 25%;">
                                            ...
                                            <!-- Meta divider line -->
                                            <div style="width: 80px; height: 1px; background-color: #C89B3C; margin: 3px 0 3px auto;"></div>
                        ...
                        <div class="modal-footer bg-light border-top px-4 py-3 justify-content-between">
                            <a id="btnDownloadPdf" href="" class="btn btn-success rounded-3 btn-sm fw-semibold">
                                <i class="fa-solid fa-file-pdf me-1"></i>Unduh PDF Sekarang
                            </a>
...
document.getElementById('searchForm').addEventListener('submit', function(e) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            // Format newlines and highlight double quotes for HTML preview
            ...
            // Handle images (logos & signatures) using Base64 data to completely bypass browser and web server loading issues
            if (cert.logo_base64) {
