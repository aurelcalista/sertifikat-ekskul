                ...
                <div class="card verify-card shadow-sm">
                    ...
                    <div class="card-body p-4 p-md-5 text-center">
                        ...
                        <div class="metadata-group text-start">
                            ...
                            <div class="metadata-item">
                                <span class="metadata-label"><i class="fa-solid fa-school"></i> Sekolah</span>
                                <span class="metadata-value">{{ $certificate->sekolah }}</span>
                            </div>
                            
                            <div class="metadata-item">
                                <span class="metadata-label"><i class="fa-solid fa-graduation-cap"></i> Kelas</span>
                                <span class="metadata-value text-uppercase">{{ $certificate->kelas }}</span>
                            </div>
                        </div>
